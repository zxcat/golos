...
FC_REFLECT((steemit::plugins::private_message::private_message_operation),
           (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message))

namespace fc {

    void to_variant(const steemit::plugins::private_message::private_message_plugin_operation &, fc::variant &);

    void from_variant(const fc::variant &, steemit::plugins::private_message::private_message_plugin_operation &);
...
namespace steemit {
    namespace protocol {
        ...
        void operation_validate(const plugins::private_message::private_message_plugin_operation &o);
...
FC_REFLECT_TYPENAME((steemit::plugins::private_message::private_message_plugin_operation))
