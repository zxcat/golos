...
FC_REFLECT(steemit::plugins::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message))

STEEMIT_DECLARE_OPERATION_TYPE(steemit::plugins::private_message::private_message_plugin_operation)
