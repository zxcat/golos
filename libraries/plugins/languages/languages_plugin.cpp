    ...
    namespace plugins {
        namespace languages {
            ...
            namespace detail {
                ...
                public:
                    languages_plugin_impl() : _db(
                            appbase::app().get_plugin<steemit::plugins::chain::chain_plugin>().db()) {
                    }
                ...
                struct operation_visitor {
                    ...
                    void
                    update_indirect_vote(account_object::id_type a, account_object::id_type b, int positive) const {
                        if (a == b) {
                            return;
                        }
...
//
//                    return CLD2::LanguageCode(CLD2::DetectLanguage(op.body.c_str(), static_cast<int>(op.body.size()), isPlainText, &isReliable));
                    }
...
*/
            ...
            void languages_plugin::set_program_options(boost::program_options::options_description &cli,
