...
#define LANGUAGES_PLUGIN_NAME "languages"
    ...
    public:
        ...
        static const std::string &name() {
            static std::string name = LANGUAGES_PLUGIN_NAME;
            return name;
        }
...
FC_REFLECT((golos::plugins::languages::comment_metadata), (language));

FC_REFLECT((golos::plugins::languages::get_languages_r), (languages))

FC_REFLECT((golos::plugins::languages::language_object),
...
CHAINBASE_SET_INDEX_TYPE(golos::plugins::languages::language_object, golos::plugins::languages::language_index)

FC_REFLECT((golos::plugins::languages::language_stats_object),
           (id)(language)(total_children_rshares2)(total_payout)(net_votes)(top_posts)(comments));
CHAINBASE_SET_INDEX_TYPE(golos::plugins::languages::language_stats_object,
                         golos::plugins::languages::language_stats_index)

FC_REFLECT((golos::plugins::languages::peer_stats_object),
           (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank));
CHAINBASE_SET_INDEX_TYPE(golos::plugins::languages::peer_stats_object, golos::plugins::languages::peer_stats_index)

FC_REFLECT((golos::plugins::languages::author_language_stats_object),
           (id)(author)(language)(total_posts)(total_rewards))
CHAINBASE_SET_INDEX_TYPE(golos::plugins::languages::author_language_stats_object,
                         golos::plugins::languages::author_language_stats_index)
