...
namespace block_info {
    ...
    get_block_info_r plugin::impl::get_block_info(const get_block_info_a & args) {
    ...
    get_blocks_with_info_r plugin::impl::get_blocks_with_info(const get_blocks_with_info_a & args) {    
    ...
    void plugin::impl::on_applied_block(const protocol::signed_block &b) {
