    ...
    namespace plugins {
        namespace tags {
            ...
            namespace detail {
                ...
                public:
                    tags_plugin_impl() : _db(appbase::app().get_plugin<steemit::plugins::chain::chain_plugin>().db()) {
                    }
                ...
                struct operation_visitor {
                    ...
                    void
                    create_tag(const string &tag, const comment_object &comment, double hot, double trending) const {
                    ...
                    const peer_stats_object &
                    get_or_create_peer_stats(account_object::id_type voter, account_object::id_type peer) const {
