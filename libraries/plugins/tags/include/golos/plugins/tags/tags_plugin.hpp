...
#define TAGS_PLUGIN_NAME "tags"
                    ...
                    indexed_by<ordered_unique<tag<by_id>, member<tag_object, tag_object::id_type, &tag_object::id>>,
                            ...
                            ordered_unique<tag<by_reward_fund_net_rshares>,
                                    ...
                                    composite_key_compare<std::less<tag_name_type>, std::less<bool>,
                                            std::greater<int64_t>, std::less<tag_id_type>>> >,
                    allocator<tag_object> > tag_index;
            ...
            typedef chainbase::shared_multi_index_container<author_tag_stats_object, indexed_by<
                    ...
                    ordered_unique<tag<by_author_posts_tag>, composite_key<author_tag_stats_object,
                            ...
                            composite_key_compare<less<account_object::id_type>, greater<uint32_t>,
                                    less<tag_name_type>>>, ordered_unique<tag<by_author_tag_posts>,
             ...
             *
             */
            class tags_plugin : public appbase::plugin<tags_plugin> {
            public:
                tags_plugin();
                ...
                static const std::string &name() {
                    static std::string name = TAGS_PLUGIN_NAME;
                    return name;
                }
...
CHAINBASE_SET_INDEX_TYPE(golos::plugins::tags::tag_object, golos::plugins::tags::tag_index)

FC_REFLECT((golos::plugins::tags::tag_stats_object),
           (id)(tag)(total_children_rshares2)(total_payout)(net_votes)(top_posts)(comments));
CHAINBASE_SET_INDEX_TYPE(golos::plugins::tags::tag_stats_object, golos::plugins::tags::tag_stats_index)

FC_REFLECT((golos::plugins::tags::peer_stats_object),
           (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank));
CHAINBASE_SET_INDEX_TYPE(golos::plugins::tags::peer_stats_object, golos::plugins::tags::peer_stats_index)

FC_REFLECT((golos::plugins::tags::comment_metadata), (tags));

FC_REFLECT((golos::plugins::tags::author_tag_stats_object), (id)(author)(tag)(total_posts)(total_rewards))
CHAINBASE_SET_INDEX_TYPE(golos::plugins::tags::author_tag_stats_object,
