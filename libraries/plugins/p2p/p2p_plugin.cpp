                ...
                bool p2p_plugin_impl::handle_block(const block_message &blk_msg, bool sync_mode, std::vector<fc::uint160_t> &) {
                    try {
                        ...
                        try {
                            ...
                            return result;
                        } catch (const golos::chain::exceptions::chain::unlinkable_block<> &e) {
                            ...
                            FC_THROW_EXCEPTION(golos::network::exceptions::unlinkable_block<>,
                        ...
                        return chain.db().with_read_lock([&]() {
                            ...
                            if (blockchain_synopsis.empty() ||
                                ...
                                if (!found_a_block_in_synopsis)
                                    FC_THROW_EXCEPTION(golos::network::exceptions::peer_is_on_an_unreachable_fork<>,
                            ...
                            if (reference_point != item_hash_t()) {
                                ...
                                if (is_included_block(reference_point)) {
                                    ...
                                    if (non_fork_high_block_num < low_block_num) {
                                        ...
                                        FC_THROW_EXCEPTION(
                                                golos::network::exceptions::block_older_than_undo_history<>,
