...
FC_REFLECT_DERIVED((golos::plugins::market_history::bucket_key), ((golos::plugins::market_history::key_interface)),
                   (seconds)(open));
...
CHAINBASE_SET_INDEX_TYPE(golos::plugins::market_history::bucket_object,
                         golos::plugins::market_history::bucket_index);
