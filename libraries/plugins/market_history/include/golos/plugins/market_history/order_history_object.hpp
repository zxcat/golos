...
#include <golos/plugins/market_history/market_history_object_types.hpp>
...
namespace golos {
    namespace plugins {
        namespace market_history {
            ...
            typedef multi_index_container<order_history_object, indexed_by<ordered_unique<tag<golos::chain::by_id>,
...
FC_REFLECT((golos::plugins::market_history::order_history_object), (id)(key)(time)(op));
CHAINBASE_SET_INDEX_TYPE(golos::plugins::market_history::order_history_object,
                         golos::plugins::market_history::order_history_index);

FC_REFLECT_DERIVED((golos::plugins::market_history::history_key), ((golos::plugins::market_history::key_interface)),
                   (sequence));
