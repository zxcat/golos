...
FC_REFLECT( (steemit::plugins::follow_api::get_followers_a),
            (account)(start)(type)(limit) );

FC_REFLECT( (steemit::plugins::follow_api::get_followers_r),
            (followers) );

FC_REFLECT( (steemit::plugins::follow_api::get_following_r),
            (following) );

FC_REFLECT( (steemit::plugins::follow_api::get_follow_count_a),
            (account) );

FC_REFLECT( (steemit::plugins::follow_api::get_follow_count_r),
            (account)(follower_count)(following_count) );

FC_REFLECT( (steemit::plugins::follow_api::get_feed_entries_a),
            (account)(start_entry_id)(limit) );

FC_REFLECT( (steemit::plugins::follow_api::get_feed_entries_r),
            (feed) );

FC_REFLECT( (steemit::plugins::follow_api::get_feed_r),
            (feed) );

FC_REFLECT( (steemit::plugins::follow_api::get_blog_entries_r),
            (blog) );

FC_REFLECT( (steemit::plugins::follow_api::get_blog_r),
            (blog) );

FC_REFLECT( (steemit::plugins::follow_api::get_account_reputations_a),
            (account_lower_bound)(limit) );

FC_REFLECT( (steemit::plugins::follow_api::get_account_reputations_r),
            (reputations) );

FC_REFLECT( (steemit::plugins::follow_api::get_reblogged_by_a),
            (author)(permlink) );

FC_REFLECT( (steemit::plugins::follow_api::get_reblogged_by_r),
            (accounts) );

FC_REFLECT( (steemit::plugins::follow_api::get_blog_authors_a),
            (blog_account) );

FC_REFLECT( (steemit::plugins::follow_api::get_blog_authors_r),
            (blog_authors) );
