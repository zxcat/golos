...
namespace steemit {
    namespace plugins {
        namespace debug_node {
                ...
                public:
                    debug_node_plugin_impl(debug_node_plugin *self): _self(self),database_(appbase::app().get_plugin<steemit::plugins::chain::chain_plugin>().db()) {
                    }
                    ...
                    void debug_update(Lambda &&callback, uint32_t skip = steemit::chain::database::skip_nothing) {
                        ...
                        chain::block_id_type head_id = database().head_block_id();
                        ...
                        fc::optional<chain::signed_block> head_block = database().fetch_block_by_id(head_id);
                        ...
                        database().pop_block();
                        database().push_block(*head_block, skip);
                    }
            ...
            void debug_node_plugin::plugin_startup() {
                ...
                chain::database &db = _my->database();
...
*/
            ...
            uint32_t debug_node_plugin::debug_generate_blocks(
                ...
                steemit::chain::database &db = _my->database();
                ...
                while (produced < count) {
                    ...
                    if (debug_key != "") {
                        ...
                        if (scheduled_key != debug_public_key) {
                            ...
                            _my->debug_update([=](chain::database &db) {
