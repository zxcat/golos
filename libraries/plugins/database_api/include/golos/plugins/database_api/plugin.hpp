...
namespace golos {
    namespace plugins {
        namespace database_api {
            ...
            DEFINE_API_ARGS(get_vesting_delegations, msg_pack, std::vector<vesting_delegation_api_object>)
            DEFINE_API_ARGS(get_expiring_vesting_delegations, msg_pack, std::vector<vesting_delegation_expiration_api_object>)
            ...
            ///asset
            DEFINE_API_ARGS(get_assets_dynamic_data, msg_pack, std::vector<optional<asset_dynamic_data_object>>)
            DEFINE_API_ARGS(get_assets_by_issuer, msg_pack, std::vector<optional<asset_object>>)
            ///categories
            ...
            DEFINE_API_ARGS(get_proposed_transactions, msg_pack, std::vector<proposal_object>)
            DEFINE_API_ARGS(list_assets, msg_pack, std::vector<asset_object>)
            DEFINE_API_ARGS(get_bitassets_data, msg_pack, std::vector<optional<asset_bitasset_data_object>>)
