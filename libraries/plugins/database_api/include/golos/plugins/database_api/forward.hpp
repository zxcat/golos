...
namespace golos {
    namespace plugins {
        namespace database_api {
            ...
            typedef golos::chain::vesting_delegation_object vesting_delegation_api_object;
            typedef golos::chain::vesting_delegation_expiration_object vesting_delegation_expiration_api_object;
            typedef golos::chain::reward_fund_object reward_fund_api_object;
        }
    }
}
