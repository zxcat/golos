...
namespace steemit {
    namespace plugins {
        namespace database_api {
            ...
            DEFINE_API_ARGS( get_recovery_request,                   msg_pack,   optional< account_recovery_request_api_obj > )
            ...
            ///categories
            DEFINE_API_ARGS( get_trending_categories,                msg_pack,   vector<category_api_obj>)
            ///
            DEFINE_API_ARGS(get_account_balances,                    msg_pack,   vector<asset_17> )
            DEFINE_API_ARGS(get_active_categories,                   msg_pack,   vector<category_api_obj> )
            DEFINE_API_ARGS(get_recent_categories,                   msg_pack,   vector<category_api_obj> )
            ...
            DEFINE_API_ARGS(get_best_categories,                     msg_pack,   vector<category_api_obj>)
