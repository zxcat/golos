...
namespace golos {
    namespace plugins {
        namespace account_statistics {
            ...
            struct account_stats_bucket_object : public object<account_stats_bucket_object_type,
            ...
            using account_stats_bucket_id_type = account_stats_bucket_object::id_type;

            struct account_activity_bucket_object : public object<account_activity_bucket_object_type,
            ...
            using account_activity_bucket_id_type = account_activity_bucket_object::id_type;

            class plugin final : public appbase::plugin<plugin> {
            public:

                static const std::string &name() {
                    static std::string name = ACCOUNT_STATISTICS_PLUGIN_NAME;
                    return name;
                }
...
FC_REFLECT((golos::plugins::account_statistics::account_stats_bucket_object),
           (id)(open)(seconds)(name)(transactions)(market_bandwidth)(non_market_bandwidth)(total_ops)(market_ops)(
                   forum_ops)(root_comments)(root_comment_edits)(root_comments_deleted)(replies)(reply_edits)(
                   replies_deleted)(new_root_votes)(changed_root_votes)(new_reply_votes)(changed_reply_votes)(
                   author_reward_payouts)(author_rewards_sbd)(author_rewards_vests)(author_rewards_total_steem_value)(
                   author_rewards_payout_sbd_value)(curation_reward_payouts)(curation_rewards_vests)(
                   curation_rewards_steem_value)(curation_rewards_payout_sbd_value)(liquidity_reward_payouts)(
                   liquidity_rewards)(transfers_to)(transfers_from)(steem_sent)(steem_received)(sbd_sent)(sbd_received)(
                   sbd_interest_payments)(sbd_paid_as_interest)(transfers_to_vesting)(steem_vested)(new_vests)(
                   new_vesting_withdrawal_requests)(modified_vesting_withdrawal_requests)(
                   vesting_withdrawals_processed)(finished_vesting_withdrawals)(vests_withdrawn)(
                   steem_received_from_withdrawls)(steem_received_from_routes)(vests_received_from_routes)(
                   sbd_conversion_requests_created)(sbd_to_be_converted)(sbd_conversion_requests_filled)(
                   steem_converted)(limit_orders_created)(limit_orders_filled)(limit_orders_cancelled)(
                   limit_order_steem_paid)(limit_order_steem_received)(limit_order_sbd_paid)(limit_order_sbd_received)(
                   total_pow)(estimated_hashpower))
//SET_INDEX_TYPE( golos::account_statistics::account_stats_bucket_object,)

FC_REFLECT((golos::plugins::account_statistics::account_activity_bucket_object),
