...
namespace steemit {
    namespace plugins {
        namespace account_history {
            ...
            struct account_history_plugin::account_history_plugin_impl final {
            public:
                account_history_plugin_impl()
                        : _self(appbase::app().get_plugin<chain_interface::chain_plugin>().db()) {
                }
            ...
            void account_history_plugin::set_program_options(boost::program_options::options_description &cli,
            ...
            void account_history_plugin::plugin_initialize(const boost::program_options::variables_map &options) {
                ...
                my->database().pre_apply_operation.connect(
