...
namespace steemit {
    namespace plugins {
        namespace blockchain_statistics {
            ...
            using bucket_id_type = object_id<bucket_object> ;
...
CHAINBASE_SET_INDEX_TYPE(steemit::plugins::blockchain_statistics::bucket_object, steemit::plugins::blockchain_statistics::bucket_index)
