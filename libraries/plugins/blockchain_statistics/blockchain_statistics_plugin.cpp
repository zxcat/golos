...
namespace steemit {
    ...
    namespace blockchain_statistics {
        ...
        void blockchain_statistics_plugin::set_program_options(
        ...
        void blockchain_statistics_plugin::plugin_initialize(const boost::program_options::variables_map &options) {
            try {
                ...
                _my.reset(new blockchain_statistics_plugin_impl());
                auto &db = _my->database();

                db.applied_block.connect([&](const protocol::signed_block &b) { _my->on_block(b); });
