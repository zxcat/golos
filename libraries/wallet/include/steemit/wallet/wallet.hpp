...
class wallet_api
{
   public:
       ...
       *  @param broadcast true if you wish to broadcast the transaction
       */
      annotated_signed_transaction create_account_delegated( string creator, asset steemit_fee, asset delegated_vests, string new_account_name, string json_meta, bool broadcast );
...
struct plain_keys {
 ...
 // steemit::wallet::remote_node_api,
 //        (get_key_references)
 //        (trash_meth)
...
// #include <steemitit/application/api.hpp>
// #include <steemitit/private_message/private_message_plugin.hpp>
// #include <steemitit/follow/follow_api.hpp>
// #include <steemitit/market_history/market_history_api.hpp>
...
// using namespace steemitit::application;
// using namespace steemitit::chain;
...
//         using steemitit::application::discussion;
//         using namespace steemitit::private_message;
...
//             /**
//             *  Gets the steemit price per mvests
//             */
//             string get_steemit_per_mvests() const;
...
//              *
//              *  @param creator The account creating the new account
//              *  @param steemit_fee The amount of the fee to be paid with GOLOS
//              *  @param delegated_vests The amount of the fee to be paid with delegation
//              *  @param new_account_name The name of the new account
//              *  @param json_meta JSON Metadata associated with the new account
//              *  @param broadcast true if you wish to broadcast the transaction
...
//              * @param escrow_id A unique id for the escrow transfer. (from, escrow_id) must be a unique pair
//              * @param sbd_amount The amount of SBD to transfer
//              * @param steemit_amount The amount of GOLOS to transfer
//              * @param fee The fee paid to the agent
//              * @param ratification_deadline The deadline for 'to' and 'agent' to approve the escrow transfer
//              * @param escrow_expiration The expiration of the escrow transfer, after which either party can claim the funds
//              * @param json_meta JSON encoded meta data
...
//              * @param escrow_id A unique id for the escrow transfer
//              * @param sbd_amount The amount of SBD that will be released
//              * @param steemit_amount The amount of GOLOS that will be released
//              * @param broadcast true if you wish to broadcast the transaction
//              */
//             annotated_signed_transaction escrow_release(
//                     string from,
...
//              *
//              * @param operation_type the type of operation to return, must be one of the
//              *                       operations defined in `steemitit/chain/operations.hpp`
//              *                       (e.g., "global_parameters_update_operation")
//              * @return a default-constructed operation of the given type
//              */
//             operation get_prototype_operation(string operation_type);
...
// FC_REFLECT(steemitit::wallet::wallet_data,
//         (cipher_keys)
//                 (ws_server)
//                 (ws_user)
//                 (ws_password)
...
// FC_REFLECT(steemitit::wallet::brain_key_info, (brain_priv_key)(wif_priv_key)(pub_key))

// FC_REFLECT_DERIVED(steemitit::wallet::signed_block_with_info, (steemitit::chain::signed_block),
//         (block_id)(signing_key)(transaction_ids))

// FC_REFLECT(steemitit::wallet::plain_keys, (checksum)(keys))

// FC_REFLECT_ENUM(steemitit::wallet::authority_type, (owner)(active)(posting))

// FC_REFLECT(steemitit::wallet::approval_delta,
...
// FC_API(steemitit::wallet::wallet_api,
// /// wallet api
//         (help)(get_help)
//                 (about)(is_new)(is_locked)(lock)(unlock)(set_password)
//                 (load_wallet_file)(save_wallet_file)
...
// FC_REFLECT(steemitit::wallet::memo_data, (from)(to)(nonce)(check)(encrypted))
