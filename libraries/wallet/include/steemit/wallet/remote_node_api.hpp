...
namespace steemit {
    namespace wallet {
        ...
        struct remote_node_api {
            ...
            database_api::feed_history_api_obj get_feed_history();
            ...
            database_api::reward_fund_api_object get_reward_fund(string);

            std::vector<std::vector<steemit::protocol::account_name_type> > get_key_references(vector<public_key_type>);

            std::vector<steemit::plugins::database_api::extended_account> get_accounts(vector<account_name_type>);
            ...
            // vector< database_api::withdraw_vesting_route_api_object > get_withdraw_routes( account_name_type, condenser_api::withdraw_route_type );
            ...
            // vector< database_api::vesting_delegation_api_object > get_vesting_delegations( account_name_type, account_name_type, uint32_t );
            // vector< database_api::vesting_delegation_expiration_api_object > get_expiring_vesting_delegations( account_name_type, time_point_sec, uint32_t );
            ...
            steemit::plugins::network_broadcast_api::broadcast_transaction_synchronous_return broadcast_transaction_synchronous(
                    signed_transaction);
