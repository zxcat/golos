...
namespace golos {
    namespace protocol {
        ...
        asset<Major, Hardfork, Release, type_traits::static_range<Hardfork <= 16>>::asset(share_type a,
                ...
                : asset_interface<Major, Hardfork, Release, uint8_t, asset_symbol_type, share_type>(a, id) {

        }

        template<uint8_t Major, uint8_t Hardfork, uint16_t Release>
        asset<Major, Hardfork, Release, type_traits::static_range<Hardfork <= 16>>::asset(share_type a, asset_name_type name)
                : asset_interface<Major, Hardfork, Release, uint8_t, asset_symbol_type, share_type>(a, asset_symbol_type()) {
        ...
        asset<Major, Hardfork, Release, type_traits::static_range<Hardfork >= 17>>::asset(share_type a,
                ...
                : asset_interface<Major, Hardfork, Release, uint8_t, asset_name_type, share_type>(a, asset_name_type(), 3) {
        ...
        asset<Major, Hardfork, Release, type_traits::static_range<Hardfork >= 17>>::asset(share_type a,
                                                                                          ...
                                                                                          uint8_t d)
                : asset_interface<Major, Hardfork, Release, uint8_t, asset_name_type, share_type>(a, name, d) {
